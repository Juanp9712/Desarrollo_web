...
function WordSearchController(gameId, listId, solveId, newGameId, instructionsId, themeId) {
	...
	var searchTypes = {
		...
		"palabras": [["HTML", "css", "javascript", "div"],
			["repositorio", "github", "git", "diseno"],
			["class", "normalize", "padding", "margin"],
			["fuente", "bootstrap", "body", "head"],
			["web",  "dom",  "figma", "visualstudio"]],
	};

	var game;
	var view;

	var mainInstructions = "Encuentra todas las palabras que estan en el recuadro, ¡¡Buena suerte!!";
